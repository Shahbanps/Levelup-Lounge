...
class SquadBookingPage extends StatefulWidget {
  const SquadBookingPage({Key? key}) : super(key: key);

  @override
  _SquadBookingPageState createState() => _SquadBookingPageState();
}

class _SquadBookingPageState extends State<SquadBookingPage> {
  final List times = [
    '09:00 - 10:00',
    '10:00 - 11:00',
    '11:00 - 12:00',
  ...
  Future<void> checkSlotAvailabilityAndBook() async {
    ...
    QuerySnapshot<Map<String, dynamic>> snapshot = await FirebaseFirestore
        ...
        .where('mode', isEqualTo: "SquadRoom")
    ...
    if (slotsAvailable) {
      ...
      if (totalPcnow + newNoOfSeats <= 5) {
        ...
        int available = 5 - totalPcnow;
        Fluttertoast.showToast(
          msg: 'Only $available room\'s available',
          toastLength: Toast.LENGTH_SHORT,
          gravity: ToastGravity.BOTTOM,
          timeInSecForIosWeb: 1,
          backgroundColor: Colors.red,
