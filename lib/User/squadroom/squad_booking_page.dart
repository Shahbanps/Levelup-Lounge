...
class SquadBookingPage extends StatefulWidget {
  ...
  @override
  State<SquadBookingPage> createState() => SquadCBookingPageState();
}

class SquadCBookingPageState extends State<SquadBookingPage> {
  final List dates = [
    'date 1',
    'date 2',
    'date 3',
              ...
              child: Row(
                ...
                children: [
                  Padding(
                    ...
                    child: Text(
                      "Squad Room  .  Five PC's  .  500₹  .  per slot / five people",
                      style: GoogleFonts.bebasNeue(
                        fontSize: 15,
                        color: Colors.white,
                      ),
