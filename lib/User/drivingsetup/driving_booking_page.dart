...
class DrivingBookingPage extends StatefulWidget {
  ...
  @override
  DrivingBookingPageState createState() => DrivingBookingPageState();
}

class DrivingBookingPageState extends State<DrivingBookingPage> {
  final List times = [
    '09:00 - 10:00',
    '10:00 - 11:00',
    '11:00 - 12:00',
  ...
  Future<void> checkSlotAvailabilityAndBook() async {
    ...
    if (slotsAvailable) {
      ...
      if (totalPcnow + newNoOfSeats <= 4) {
        ...
        int available = 4 - totalPcnow;
        Fluttertoast.showToast(
          msg: 'Only $available driving setup\'s is available',
          toastLength: Toast.LENGTH_SHORT,
          gravity: ToastGravity.BOTTOM,
          timeInSecForIosWeb: 1,
          backgroundColor: Colors.red,
                ...
                child: Row(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Text(
                        "Driving  .  setup  .  300₹  .  per person/per setup",
                        style: GoogleFonts.bebasNeue(
                          fontSize: 12,
                          color: Color.fromARGB(255, 255, 255, 255),
                        ),
