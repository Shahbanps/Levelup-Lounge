...
//           'items_bought': _cartItems.map((cartItem) => cartItem.product.name).toList(),
...
//                 ),
//               ),
//               content: Text('Total amount: \$${_calculateTotal().toStringAsFixed(2)}'),
//               actions: [
//                 TextButton(
//                   onPressed: () {
...
//     }
//   } else {
//     // Show an error dialog if the user is not logged in or user ID is not available
//     showDialog(
//       context: context,
//       builder: (BuildContext context) {
//         return AlertDialog(
